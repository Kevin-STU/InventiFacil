...
public class Fabrica {
    ...
    public static boolean realizarVenta() {
        System.out.println("=== Realizar Venta ===");
        return vendedor.realizarVenta();
    }
    ...
    public static void mostrarMenuAdministrador() {
        ...
        while (!salir) {
            ...
            System.out.println("1. Generar informe de inventario");
    ...
    public static void generarInformeInventario() {
        ...
        administrador.generarInformeInventario();
    }
    public static void generarInformeVentas(){
        double ventasTotales = vendedor.carritoActual.getVentasTotales();
